...
public interface ChatMessageMapper extends BaseMapper<ChatMessage> {
    @Select("SELECT * FROM chat_message WHERE workflow_request_id=#{requestId} AND output_key=#{outputKey}")
    ChatMessage byOutputKey(@Param("requestId") String requestId, @Param("outputKey") String outputKey);
