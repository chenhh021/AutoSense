...
public class RepairExecutionRunner {
    ...
    private com.chh.autosense.api.dto.ConclusionDto buildConclusion(RepairSession session) {
        ...
        return new com.chh.autosense.api.dto.ConclusionDto(
                ...
                extra.containsKey("afterSales")
                        ? typedList(extra.get("afterSales"),
                                com.chh.autosense.aftersales.AfterSalesLocation.class) : null);
    }
